import '../bridge_pose/bridge_pose_widget.dart';
import '../cobra_pose/cobra_pose_widget.dart';
                ...
                child: InkWell(
                  onTap: () async {
                    await Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => LotusPoseWidget(),
                      ),
                    );
                  },
                  child: Row(
                ...
                child: InkWell(
                  onTap: () async {
                    await Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => DownwardPoseWidget(),
                      ),
                    );
                  },
                  child: Row(
                ...
                child: InkWell(
                  onTap: () async {
                    await Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => WarriorPoseWidget(),
                      ),
                    );
                  },
                  child: Row(
                ...
                child: InkWell(
                  onTap: () async {
                    await Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => TreePoseWidget(),
                      ),
                    );
                  },
                  child: Row(
                ...
                child: InkWell(
                  onTap: () async {
                    await Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => BridgePoseWidget(),
                      ),
                    );
                  },
                  child: Row(
                ...
                child: InkWell(
                  onTap: () async {
                    await Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => TrianglePoseWidget(),
                      ),
                    );
                  },
                  child: Row(
                ...
                child: InkWell(
                  onTap: () async {
                    await Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => SeatedPoseWidget(),
                      ),
                    );
                  },
                  child: Row(
                ...
                child: InkWell(
                  onTap: () async {
                    await Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => CobraPoseWidget(),
                      ),
                    );
                  },
                  child: Row(
