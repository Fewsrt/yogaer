...
import '../detect_pose/detection_tree_pose_widget.dart';
...
class TreePoseWidget extends StatefulWidget {
  const TreePoseWidget({Key key}) : super(key: key);

  @override
  _TreePoseWidgetState createState() => _TreePoseWidgetState();
}

class _TreePoseWidgetState extends State<TreePoseWidget> {
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        await Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => DetectionTreePoseWidget(cameras : cameras),
                          ),
                        );
                      },
                      text: 'Start',
