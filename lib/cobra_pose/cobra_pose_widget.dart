...
import '../detect_pose/detection_cobra_pose_widget.dart';
      ...
      body: Column(
        ...
        children: [
          FlutterFlowYoutubePlayer(
            url: 'https://www.youtube.com/watch?v=XU0wJ0OTopUhF43PuM',
            autoPlay: false,
            looping: true,
            mute: false,
            showControls: true,
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        await Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => DetectionCobraPoseWidget(cameras : cameras),
                          ),
                        );
                      },
                      text: 'Start',
